...
import {mainnet,polygon,optimism,bsc,arbitrum,avalanche,celo,polygonMumbai} from 'viem/chains';
...
const config = createConfig(
	getDefaultConfig({
		appName: "tempApp",
        chains:[mainnet,polygon,optimism,bsc,arbitrum,avalanche,celo,polygonMumbai],
